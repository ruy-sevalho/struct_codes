...
from struct_codes.base_section.compression import (
...
@dataclass
class BeamElement(Beam, Section, Protocol):
...
@dataclass
class BeamAngles(Beam):
    pass


@dataclass
class BeamAnalysisISection:
